  /* var projectname = "https://arras-client-template-new" //Please set this as your original link to fix bugs.
if (window.location.href.indexOf(projectname+".glitch.me/#") > -1) {
    window.top.location = projectname+".glitch.me"
    }*/

// That thing above was old because it was for fixing bugs with the client but it's not needed anymore!
~function() {
  "use strict";
  var I = I || {};
  I.scope = {};
      ...
      const e = {
        ...
        servers: [
          ...
          },
          {
            ...
            id: "Railway-FFA",
            type: "ffa",
            code: "railway-worldwide-f",
            at: p.railway('loomy-arras-server-production'), //replace arras-template with your server
            prefer: !0,
           // featured: 1, // For Featured Status. (shiny)

          },
          {
            visible: 0,
            id: "Replit-Domination",
            type: "domination",
            code: "replit-worldwide-d",
            at: p.replit("loomy-arras-server.hussainabidi1"), //same thing here
           // featured: 1, // For Featured Status. (shiny)
          },
        ]
          .map((a, e) => ({ data: a, i: e }))
